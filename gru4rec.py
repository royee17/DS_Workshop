...
class GRU4Rec:
    ...
    def evaluate_sessions(self, test_data, train_data, items=None, cut_off=20, session_key='SessionId', item_key='ItemId', time_key='Time'):    
        '''
        ...
        for i in range(len(test_data)):
            ...
            if prev_sid != sid:
                ...
                preds = self.predict_next(sid, prev_iid, items_to_predict)
